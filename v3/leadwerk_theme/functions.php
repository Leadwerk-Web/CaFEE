 ...
 * WordPress speichert Template-Parts oft in der DB – wp_footer ist zuverlässiger als parts/footer.html.
 */
...
/**
 * window.open vor dem OpenTable-Widget abfangen (Popup statt neuem Tab).
 */
