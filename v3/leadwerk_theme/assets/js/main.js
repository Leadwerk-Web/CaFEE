...
function initOpenTableOverlayFallback() {
    ...
    // #region agent log
    fetch('http://127.0.0.1:7644/ingest/731be871-f418-45fb-b234-c28e7c0f814e',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'63bf60'},body:JSON.stringify({sessionId:'63bf60',runId:'ot-popup-fix',hypothesisId:'A',location:'main.js:initOpenTableOverlayFallback',message:'OpenTable fallback init',data:{hasModal:!!fallbackModal,hasFrame:!!fallbackFrame,pendingUrl:window.__otPendingBookingUrl||null},timestamp:Date.now()})}).catch(()=>{});
    // #endregion
    ...
    const openFallback = (url) => {
        ...
        // #region agent log
        fetch('http://127.0.0.1:7644/ingest/731be871-f418-45fb-b234-c28e7c0f814e',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'63bf60'},body:JSON.stringify({sessionId:'63bf60',runId:'ot-popup-fix',hypothesisId:'B',location:'main.js:openFallback',message:'Opening OT popup',data:{url:url},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
        closeMobileNavIfOpen();
