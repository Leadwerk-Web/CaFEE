...
(function () {
    ...
    var configuredOpeningDate = countdownRoot ? countdownRoot.getAttribute('data-opening-date') : '';
    var OPENING_DATE = new Date(configuredOpeningDate || '2026-07-11T09:00:00+02:00');
    var SHARE_URL = (window.cafeeEroeffnung && window.cafeeEroeffnung.shareUrl) || 'https://cafee-brueckenmuehle.de/eroeffnung/';
